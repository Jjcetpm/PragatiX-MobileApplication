...
class AttendanceSettingsYearSelectionPage extends StatefulWidget {
  const AttendanceSettingsYearSelectionPage({super.key});

  @override
  State<AttendanceSettingsYearSelectionPage> createState() =>
      _AttendanceSettingsYearSelectionPageState();
}

class _AttendanceSettingsYearSelectionPageState
    extends State<AttendanceSettingsYearSelectionPage> {
      ...
      child: InkWell(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => AttendanceSettingsPage(academicYear: yearValue),
            ),
          );
        },
        child: Padding(
